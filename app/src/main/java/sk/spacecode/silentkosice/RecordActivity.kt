...
//
//
//            pushDataRecord(tsLong.toString(), "70","+4210903888120", "37.90909", "37.90909")
//        }
//
//
...
//
//        mRecorder.start()
//s        handler!!.postDelayed(runnable, 100)
//    }
//
//
//
...
//
//    fun updateTv() {
//        textView_currentDB.text = soundDb(getAmplitude()).toString()
//
//        imageView_circleProgress.layoutParams.height = ((getAmplitudeEMA().toInt()*100)/2700) + 100
//        imageView_circleProgress.layoutParams.width = ((getAmplitudeEMA().toInt()*100)/2700) + 100
//
//        if ( getAmplitudeEMA().toInt() > max){
//            Log.e("", getAmplitudeEMA().toInt().toString())
//        }
//    }
//
